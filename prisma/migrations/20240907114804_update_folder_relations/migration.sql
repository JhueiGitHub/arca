...
CREATE TABLE "DopaFile" (
    ...
    CONSTRAINT "DopaFile_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "DopaFile_profileId_idx" ON "DopaFile"("profileId");

-- CreateIndex
CREATE INDEX "DopaFile_folderId_idx" ON "DopaFile"("folderId");
